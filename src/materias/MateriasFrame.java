...
//        jSpinner1.setValue(1);
        ...
        ArrayList<String[]> matPen = secciones(materiasPendientes);
...
//    ArrayList<Materia> lista = new ArrayList<>();
    ...
    public ArrayList<String[]> secciones(DefaultListModel materias) {
        ...
        tele.add("CONMUTACION Y ENRUTAMIENTO DE REDES DE DATOS");
        ...
        desarrollo.add("DESARROLLO WEB EN JAVA");
        desarrollo.add("DESARROLLO WEB EN NET");

        ArrayList<String> movil = new ArrayList<>();
        movil.add("PROGRAMACION DE DISPOSITIVOS MOVILES");
        movil.add("PROGRAMACION EN DISP. MOV. EN iOS");

        ArrayList<String> single55percent = new ArrayList<>();
        single55percent.add("FUNDAMENTOS DE SEGURIDAD INFORMATICA");
        ...
        single55percent.add("DESARROLLO DE HABILIDADES PROF. EN INFORMATIC (OPTATIVA)");
...
//                    }
            ...
            for (int i = 0; i < Materia.lista.size(); i++) {
                ...
                if (materiaTabla.equals(materiaLista)) {
                    ...
                    jTable2.setValueAt(Materia.lista.get(i).aprobado, index - 1, 0);
                    jTable2.setValueAt(Materia.lista.get(i).maestroMat, index - 1, 1);
                    int mayor = 0;
                    int indice = 0;
                    ...
                    jTable2.setValueAt(Materia.lista.get(i).horarioMat[indice], index - 1, 2);
                    band = true;
